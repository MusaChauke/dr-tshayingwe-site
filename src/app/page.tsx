  ...
  return (
    <>
      ...
      <section className="mx-auto max-w-site px-4 py-14 sm:px-6 md:py-20">
        ...
        <Link
          href="/services/"
          className="mt-8 inline-flex items-center gap-2 font-bold text-navy underline decoration-gold decoration-2 underline-offset-4"
        >
      ...
      <section className="mx-auto grid max-w-site items-center gap-10 px-4 py-14 sm:px-6 md:grid-cols-2 md:py-20">
        ...
        <div>
          ...
          <Link
            href="/about/"
            className="mt-6 inline-flex items-center gap-2 font-bold text-navy underline decoration-gold decoration-2 underline-offset-4"
          >
            ...
            <ol className="space-y-4">
              {virtualConsultation.steps.map((step, i) => (
                <li key={step.title} className="flex gap-4">
                  <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full border-2 border-gold font-serif text-xl text-gold" aria-hidden="true">
                    {i + 1}
                  </span>
                  <div>
                    <div className="font-bold">{step.title}</div>
                    <div className="text-white/85">{step.body}</div>
                  </div>
                </li>
              ))}
            </ol>
        ...
        <div className="grid gap-10 md:grid-cols-2">
          <div>
            ...
            <p className="mt-4 text-lg">
              <span className="font-bold">{address.street}, {address.suburb}, {address.city}, {address.postalCode}</span>
              <br />
