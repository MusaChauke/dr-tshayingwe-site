  ...
  return (
    <>
      ...
      <section className="mx-auto max-w-site px-4 py-12 sm:px-6 md:py-16">
        <h1 className="text-4xl sm:text-5xl">GP services in Mbekweni, Paarl</h1>
        <p className="mt-4 max-w-2xl text-lg">
          {doctor.shortName} sees adults and children for an illness that needs treating today, a condition that needs
          managing for years, a check-up, a screening or a small procedure.
        </p>
      ...
      <section className="bg-cream">
        <div className="mx-auto grid max-w-site gap-10 px-4 py-12 sm:px-6 md:grid-cols-2 md:py-16">
          ...
          <div>
            <h2 className="text-3xl">{toConfirm.medicalAid.confirmed ? 'Fees and medical aid' : 'Fees'}</h2>
            <p className="mt-4">
            ...
            <p className="mt-3">
              ...
              <Link href="/contact/" className="font-bold text-navy underline decoration-gold-deep decoration-2 underline-offset-4">
                Ask us
              </Link>{' '}
              before you come in.
            </p>
